...
#             self.customer_index,
#             self.article_index
#         ) = self._create_sparse_matrix_coo(transactions_df, customers_df, articles_df)
        
#         self.reverse_customer_index = {v: k for k, v in self.customer_index.items()}
#         self.reverse_article_index = {v: k for k, v in self.article_index.items()}
